				...
				<PerfectScrollbar>
					<ul>
						<li className='d-flex justify-content-between align-items-center'>
							<div className='d-flex flex-grow-2'>
								<div className='budget-icon me-3 mt-1'>
									<img src='/images/social/facebook.png' alt='' width='40' />
								</div>
						...
						<li className='d-flex justify-content-between align-items-center'>
							<div className='d-flex flex-grow-2'>
								<div className='budget-icon me-3 mt-1'>
									<img src='/images/social/youtube.png' alt='' width='40' />
								</div>
								<div className='budget-info flex-grow-2 me-3'>
									<div className='d-flex justify-content-between mb-1'>
						...
						<li className='d-flex justify-content-between align-items-center'>
							<div className='d-flex flex-grow-2'>
								<div className='budget-icon me-3 mt-1'>
									<img src='/images/social/spotify.png' alt='' width='40' />
								</div>
								<div className='budget-info flex-grow-2 me-3'>
									<div className='d-flex justify-content-between mb-1'>
						...
						<li className='d-flex justify-content-between align-items-center'>
							<div className='d-flex flex-grow-2'>
								<div className='budget-icon me-3 mt-1'>
									<img src='/images/social/skype.png' alt='' width='40' />
								</div>
								<div className='budget-info flex-grow-2 me-3'>
									<div className='d-flex justify-content-between mb-1'>
						...
						<li className='d-flex justify-content-between align-items-center'>
							<div className='d-flex flex-grow-2'>
								<div className='budget-icon me-3 mt-1'>
									<img src='/images/social/envato.png' alt='' width='40' />
								</div>
								<div className='budget-info flex-grow-2 me-3'>
									<div className='d-flex justify-content-between mb-1'>
